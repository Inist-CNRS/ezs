...
describe('spawn through file(s)', () => {
    ...
    it.skip('with a lot of commands in spawn pipeline', (done) => {
        const commands = [
            {
                name: 'replace',
                mode: 'detachable',
        ...
        ten
            ...
            .pipe(ezs('spawn', { commands })) // ~ 9 seconds
            .on('data', (chunk) => {
                res += chunk.a;
            })
            .on('end', () => {
